...
var gamePatch = function gamePatch(event) {
  event.preventDefault();
  var data = event.target.id;
  var turn = event.target.innerText;
  var isOver = logic.winCondition();
  api.gameUpdate(data, turn, isOver).then(ui.gamePatchSuccess).catch();
};
...
module.exports = {
  ...
  turn: turn,
  isOver: isOver,
  alertCurrentPlayer: alertCurrentPlayer
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
